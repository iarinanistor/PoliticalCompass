...
#Les candidats
candidat1 = ob.Candidat('Martin','Louis',3,42,3,4)
candidat2 = ob.Candidat('Petit','Arthur',2.8,40,4,7)
candidat3 = ob.Candidat('Laurent','Marie',3.2,48,1,3)
candidat4 = ob.Candidat('Duval','Gabriel',3.2,52,3,0)

#Liste des Candidats
l_cand=[candidat1,candidat2,candidat3,candidat4]

#Liste des electeurs
l_electeur=[ob.Individus("victor",-10,10,l_cand),ob.Individus("Isaac",0,0,l_cand),ob.Individus("Lyna",-5,-25,l_cand),ob.Individus("chaby",-30,-30,l_cand)]

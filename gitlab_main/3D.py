...
nbIndividus = 1000 # mettre un grand nombre d'individus pour avoir une meilleur vision de la generation , attetion temps de calcule important pour  la genereration
map = Map(None,population=pop,generationX=100,generationY=100)
map.generation_pers((49,50,50),"Triangulaire",nbIndividus) # generation de la population

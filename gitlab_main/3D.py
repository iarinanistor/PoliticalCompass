...
if __name__ == '__main__':
    ...
    nbIndividus = 100000 # mettre un grand nombre d'individus pour avoir une meilleur vision de la generation , attetion temps de calcule important pour  la genereration

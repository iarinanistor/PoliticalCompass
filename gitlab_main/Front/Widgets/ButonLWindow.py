from PySide6.QtCore import QObject, QRect, Qt, QCoreApplication, QPropertyAnimation, QEvent
from PySide6.QtWidgets import  QWidget, QPushButton, QVBoxLayout, QHBoxLayout, QLabel, QSpinBox, QDialog,QProgressDialog, QToolTip
